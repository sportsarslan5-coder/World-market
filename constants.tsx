...
const NEW_SPORTS_BRAS: Product[] = SPORTS_BRA_IMAGES.map((img, idx) => ({
  ...
  **Shipping:** Fast global delivery with tracking.`,
  ...
  quality: "Premium",
  sizes: ['S', 'M', 'L', 'XL'],
  colors: ['Midnight Black', 'Slate Grey', 'Deep Teal', 'Berry Purple', 'Cloud White'],
  shippingCountry: "Worldwide",
  sellerId: 'seller-1',
  sales: 280,
...
const NEW_OVERSIZED_HOODIES: Product[] = OVERSIZED_HOODIE_IMAGES.map((img, idx) => ({
  ...
  **Shipping:** Worldwide shipping with real-time tracking.`,
  ...
  quality: "Premium",
  sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  colors: ['Washed Grey', 'Midnight Black', 'Cloud White', 'Sand Beige', 'Lime Green'],
  shippingCountry: "Worldwide",
  sellerId: 'seller-1',
  sales: 320,
...
const NEW_YOGA_PANTS: Product[] = YOGA_PANTS_IMAGES.map((img, idx) => ({
  ...
  **Shipping:** Global shipping with tracking.`,
  ...
  quality: "Premium",
  sizes: ['XS', 'S', 'M', 'L', 'XL'],
  colors: ['Midnight Black', 'Deep Plum', 'Navy Blue', 'Slate Grey', 'Berry Purple'],
  shippingCountry: "Worldwide",
  sellerId: 'seller-1',
  sales: 850,
